...
if __name__ == "__main__":
    ...
    model_id = run_inference(project_id_1, version="20250715105702")
    # model_id = run_inference(project_id=project_id, version="20250426165513")
    print(f"Path Reward: {model_id}")
